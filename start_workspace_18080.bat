...
start "ULOS Backend :18080" cmd /k "cd /d %BACKEND_DIR% && call run_backend_18080.bat"

echo [INFO] Starting frontend terminal...
start "ULOS Frontend :3000 -> :18080" cmd /k "cd /d %FRONTEND_DIR% && call run_frontend_3000_backend18080.bat"
